...
def plot_futurue_position_chart(data: pd.DataFrame, account_name: str, underlying_name: str, avg_entry_quote: float,
                                position_type: str) -> str:
    ...
    ax1.set_title(f'{account_name} - {position_type} {underlying_name}')
    ...
    filename = f"output/{account_name}_{underlying_name}.png"
